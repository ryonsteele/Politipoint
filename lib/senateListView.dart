...
class SenateListView extends StatefulWidget {

  final MemberData data;

  SenateListView({Key key, @required this.data}) : super(key: key);

  @override
  _SenateListView createState() => _SenateListView();
}


class _SenateListView extends State<SenateListView> {
  ...
  Future callApi(String val) async {
    ...
    print('VAL: '+val);
    Response response = await http.get('https://api.propublica.org/congress/v1/members/senate/'+val+'/current.json',
